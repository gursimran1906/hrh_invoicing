...
from .views import test, invoices_view, add_client, add_local_authority, add_rate, add_one_to_one, add_one_to_one_agency, dashboard, clients_attendance, mark_clients_attendance, get_attendance_data
